...
export default class SignInSignUp extends Component {
  ...
  render() {
    ...
    const buttonName = isLogin ? "log in" : "registered";
    const OAuthHref = `https://github.com/login/oauth/authorize?client_id=${
      this.clientId
    }`;
    return (
      <div className="formContent fadeInDown">
        ...
        <Link to={linkUrl}>
          <span className={registerClass}>Registered</span>
        </Link>
