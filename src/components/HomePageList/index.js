...
class HomePageList extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      searchResultTitle: {
        user: 'The user you have contacted',
        group: 'The group you have contacted'
      }
    };
  ...
  clickItemHandle = ({ homePageList, chatFromId }) => {
    ...
    this._chat.clearUnreadHandle({ homePageList, chatFromId });
// clear [someone@我] [@Me]    this.props.showCallMeTip({ homePageList, chatFromId, showCallMeTip: false });
  }
